#!/usr/bin/env python3
"""
Simplified Panorama Rectification Tool
Based on the A-Contrario Horizon-First Vanishing Point Detection algorithm

Usage: python simple_rectify.py input_folder output_folder
"""
...
def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: python simple_rectify.py input_folder output_folder")
        print("")
        print("This tool rectifies panoramic images using the A-Contrario Horizon-First")
        print("Vanishing Point Detection algorithm. It processes all images in the input")
        print("folder and saves rectified versions to the output folder.")
        print("")
    ...
    print("Panorama Rectification Tool")
    print("=" * 40)
